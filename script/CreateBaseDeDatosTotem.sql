...
CREATE
  ...
  (
    ...
    acu_desarrollo VARCHAR (50) NOT NULL ,
...
CREATE
  ...
  (
    ...
    CLIENTE_JURIDICO_cj_id INTEGER NOT NULL ,
...
CREATE
  ...
  (
    ...
    min_observaciones VARCHAR (500) NOT NULL ,
...
CREATE
  ...
  (
    MINUTA_min_id                         INTEGER NOT NULL ,
    INVOLUCRADOS_USUARIOS_USUARIO_usu_id  INTEGER NOT NULL ,
    INVOLUCRADOS_USUARIOS_PROYECTO_pro_id INTEGER NOT NULL ,
    CONSTRAINT MIN_INV_PK PRIMARY KEY CLUSTERED (MINUTA_min_id)
WITH
  (
    ALLOW_PAGE_LOCKS = ON ,
    ALLOW_ROW_LOCKS  = ON
...
CREATE
  ...
  (
    ...
    pun_titulo     VARCHAR (50) NOT NULL ,
    pun_desarrollo VARCHAR (100) NOT NULL ,
...
ADD CONSTRAINT INVOLUCRADOS_USUARIOS_ACUERDO_FK FOREIGN KEY
(
ACUERDO_acu_id
)
REFERENCES ACUERDO
