...
AS
	BEGIN
		SELECT R.req_descripcion as requerimiento
...
INSERT INTO CASO_USO (cu_identificador,cu_titulo,cu_condexito,cu_condfallo,cu_disparador, PROYECTO_pro_id) VALUES ('TOT-CU_1','Agregar Actor','Actor Creado','Actor no Creado','Menu principal -> Crear Actor',1);

INSERT INTO CASO_USO (cu_identificador,cu_titulo,cu_condexito,cu_condfallo,cu_disparador, PROYECTO_pro_id) VALUES ('TOT-CU_2','Leer Actor','Actor Leido','Actor no Leido','Menu principal -> Leer Actor',1);

INSERT INTO CASO_USO (cu_identificador,cu_titulo,cu_condexito,cu_condfallo,cu_disparador, PROYECTO_pro_id) VALUES ('TOT-CU_3','Modificar Actor','Actor Modificado','Actor no Modificado','Menu principal -> Modificar Actor',1);

INSERT INTO CASO_USO (cu_identificador,cu_titulo,cu_condexito,cu_condfallo,cu_disparador, PROYECTO_pro_id) VALUES ('TOT-CU_4','Eliminar Actor','Actor Eliminiado','Actor no Eliminado','Menu principal -> Eliminar Actor',1);
...
INSERT INTO ACTOR (act_nombre,act_descripcion,PROYECTO_pro_id) VALUES ('Gerente','El encargado de un departamento',1);
