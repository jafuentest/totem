...
function agregarPunto()
{
    ...
    $('#puntosMinuta').append(
        ...
        + "         <input id='" + codigoPuntoTitulo + "' maxlength='100' class='form-control' placeholder='Título del Punto' type='text'/>"
        + "     </div>"
       ...
       }).done(function (data)
       {
           ...
           for (i = 0; i < json["ListaPunto"].length; i++)
           {
               ...
               $('#puntosMinuta').append(
                    ...
                    + "         <input id='" + codigoPuntoTitulo + "' class='form-control' maxlength='100' placeholder='Título del Punto' value='" + tituloPunto + "' type='text'/>"
                    + "     </div>"
                    + "     <div class='col-xs-12 form-group'></div>"
                    + "     <div class='col-xs-12'><textarea id='" + codigoPuntoDesarrollo + "' maxlength='200' name='desarrollo' placeholder='Desarrollo del Punto' class='form-control' style='text-align:justify; resize:none;' rows=3>" + desarrolloPunto + "</textarea></div>"
                    + " </div>"
                    + "</div>"
                );
               nroPuntos++;
           ...
           $('#puntosMinuta').append(
                ...
                + "     <div class='col-xs-12'>"
                + "         <button type='button' id=" + codigoPuntoBTN + " class='close' data-dismiss='alert' onClick='borrarPunto(this);' aria-label='Close'><span aria-hidden='true'>&times;</span></button>"
                + "         <input id='" + codigoPuntoTitulo + "' maxlength='100' class='form-control' placeholder='Título del Punto' value='' type='text'/>"
                + "     </div>"
                + "     <div class='col-xs-12 form-group'></div>"
                + "     <div class='col-xs-12'><textarea id='" + codigoPuntoDesarrollo + "' name='desarrollo' maxlength='200' placeholder='Desarrollo del Punto' class='form-control' style='text-align:justify; resize:none;' rows=3></textarea></div>"
                + " </div>"
           ...
           for (i = 0; i < json["ListaAcuerdo"].length; i++)
           {
               ...
               $('#acuerdosMinuta').append(
                   ...
                   + "     <div class='col-xs-12'>"
                   + "         <button type='button' id=" + codigoAcuerdoBTN + " class='close' data-dismiss='alert' onClick='borrarAcuerdo(this);' aria-label='Close'><span aria-hidden='true'>&times;</span></button>"
                   + "         <input id='" + codigoAcuerdoCompromiso + "' class='form-control' maxlength='120' class='tituloReunion' value='" + compromisoAcuerdo + "' placeholder='Acuerdo o Compromiso' type='text'/>"
                   + "     </div>"
                   + "     <div class='col-xs-12 form-group'></div>"
                   + "     <div class='col-xs-12 col-md-4 date'> "
