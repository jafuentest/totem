<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeBehind="ModificarActor.aspx.cs" Inherits="Vista.Modulo6.ModificarActor" %>
		...
		<form runat="server" class="form-horizontal" method="POST">
			...
			<div class="form-group">
				<div class="col-md-6">
					...
					<button type="submit" runat="server" id="botonAgregar" class="btn btn-primary" onserverclick="botonModificar_ServerClick">Modificar</button>
