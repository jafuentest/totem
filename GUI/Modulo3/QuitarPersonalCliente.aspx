<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Modulo3/Modulo3.master" AutoEventWireup="true" CodeFile="QuitarPersonalCliente.aspx.cs" Inherits="GUI_Modulo3_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoCentral" Runat="Server">
      <div class="col-sm-12">
              	 <form class="form-horizontal" action="" method="POST" role="form" runat="server">
                    <legend>Quitar Empleado de Empresa Cliente a Proyecto</legend>
                        <div class="form-group">
                           <label for="" class="col-sm-3 col-sm-offset-2">Seleccione Proyecto:</label>
                             <div class="col-sm-4">
                                 <asp:DropDownList name="proyecto" id="id_proyecto" class="form-control input-sm" required="required" runat="server" AutoPostBack="True" OnSelectedIndexChanged="proyecto_SelectedIndexChanged">
                        ...
                        <div class="form-group">
                           <label for="" class="col-sm-3 col-sm-offset-2">Seleccione Persona:</label>
                               <div class="col-sm-4">
                                 <asp:DropDownList name="persona" id="id_persona" class="form-control input_sm" required="required" runat="server">
